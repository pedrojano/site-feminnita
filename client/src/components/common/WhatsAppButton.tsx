...
export function WhatsAppButton() {
  const [phone, setPhone] = useState("+5522992810707");
  ...
  return (
    <a
      ...
      className="fixed bottom-40 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-green-500 text-white shadow-xl transition-all hover:bg-green-600 active:scale-95 md:bottom-24"
